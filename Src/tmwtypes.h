...
/* ATTENZIONE: MODIFICE APPORTATE 
   Aggiunti i #define per il tipo char in modo da renderlo compatibile
   con la definizione di IAR, in cui il tipo char è unsigned char */
...
#ifndef CHARACTER_T
# define CHARACTER_T unsigned char
#endif
